DROP MATERIALIZED VIEW client_health_full_training_data_mv;
...
-- SELECT * FROM client_health_full_training_data_mv;
-- SELECT COUNT(*) FROM client_health_full_training_data;
-------------------------------------------------------------
-- SELECT DISTINCT title FROM all_dna_prebuilt_report_usage;
-------------------------------------------------------------