...
print(f"{model_name}_svm_grid_search.best_params_: {svm_grid_search.best_params_}")
print(f"{model_name}_svm_grid_search.best_score: {svm_grid_search.best_score_}")
print(f"{model_name}_svm_grid_search.param_grid: {svm_grid_search.param_grid}")
print("fin.")
