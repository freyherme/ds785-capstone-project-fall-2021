...
def check_existing_models(current_model_name, current_solver, current_c_val):
    for i, m in models_completed.iterrows():
        if m['model_name'] == current_model_name \
                and m['solver'] == current_solver\
...
for model_name, model_dict in models_dict.items():
    ...
    for solver in model_dict['solver']:
        ...
        for c_val in model_dict['c_value']:
            ...
            if check_existing_models(model_name, solver, c_val):
                print(f". . . . . . . . . . Skipping  {model_name}, solver: {solver}, c: {c_val}. . . . . . . . . . . .")
                continue
